...
const EXAMPLE_STRING_FIELD = createScalarField(EXAMPLE_FIELD_NAME, ScalarType.String, false, true);
...
describe('printEnum', () => {
    const cases: Array<[string, Enum, string]> = [
        ...
        [
            ...
            createEnum(EXAMPLE_ENUM_NAME, [EXAMPLE_ENUM_VALUE], EXAMPLE_DOCUMENTATION),
            `${printDocumentation(
...
describe('printField', () => {
    const cases: Array<[string, ObjectField | ScalarField, string]> = [
        ...
        [
            ...
            createObjectField(EXAMPLE_FIELD_NAME, EXAMPLE_OBJECT_NAME, false, true, null, [
...
${printField(EXAMPLE_STRING_FIELD)}
        ...
        [
            ...
            createModel(EXAMPLE_MODEL_NAME, [EXAMPLE_STRING_FIELD], EXAMPLE_DOCUMENTATION),
            `${printDocumentation(EXAMPLE_DOCUMENTATION)}
model ${EXAMPLE_MODEL_NAME} {
${printField(EXAMPLE_STRING_FIELD)}
}`,
...
describe('printGenerator', () => {
  ...
  output = "${EXAMPLE_GENERATOR_OUTPUT}"
        ...
        [
            'With binary targets',
            createGenerator(EXAMPLE_GENERATOR_NAME, EXAMPLE_GENERATOR_PROVIDER, null, [
